...
## Phase 0: Next.js/Vercel foundation

- [x] Add a pure Next.js App Router application.
- [x] Add a frontend landing page, job list page, job creation form, and job detail page.
- [x] Add PostgreSQL data access and initial database schema.
- [x] Add Vercel-ready package scripts and environment documentation.
- [ ] Run a production Next.js build after dependencies are available.
- [ ] Deploy to Vercel with `DATABASE_URL` configured and verify `/api/health`.

## Phase 1: Repository understanding and guardrails
...
## Phase 3: Command contract hardening
...
## Phase 4: Data contracts and validation
...
## Phase 5: Portal integration quality
...
## Phase 6: Application artifact generation
